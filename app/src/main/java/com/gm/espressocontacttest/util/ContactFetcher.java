    ...
    public ArrayList<Contact> fetchAll() {
        ...
        if (c.moveToFirst()) {
            ...
            do {
                ...
                Uri contactProfilePic = ContentUris.withAppendedId(ContactsContract.Contacts.CONTENT_URI, c.getLong(idIndex));;
                Contact contact = new Contact(contactId, contactDisplayName,contactProfilePic);
